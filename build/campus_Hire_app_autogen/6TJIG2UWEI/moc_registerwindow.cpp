...
#include "../../../include/auth/registerwindow.h"
...
void RegisterWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 4: _t->validateEmail((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1]))); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (RegisterWindow::*)()>(_a, &RegisterWindow::registrationSuccessful, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (RegisterWindow::*)()>(_a, &RegisterWindow::switchToLogin, 1))
            return;
    }
}
