...
#include "../../../include/ui/settingspage.h"
...
void SettingsPage::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->handleSaveProfile(); break;
        case 3: _t->handleChangePassword(); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (SettingsPage::*)()>(_a, &SettingsPage::backToHomeRequested, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (SettingsPage::*)()>(_a, &SettingsPage::profileUpdated, 1))
            return;
    }
}
...
// SIGNAL 0
void SettingsPage::backToHomeRequested()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void SettingsPage::profileUpdated()
{
