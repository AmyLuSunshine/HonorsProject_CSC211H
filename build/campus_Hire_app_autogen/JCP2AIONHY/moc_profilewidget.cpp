...
template <> constexpr inline auto ProfileWidget::qt_create_metaobjectdata<qt_meta_tag_ZN13ProfileWidgetE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        // Slot 'handleSaveChanges'
        QtMocHelpers::SlotData<void()>(3, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'handleOnboarding'
        QtMocHelpers::SlotData<void()>(4, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'uploadTranscript'
        QtMocHelpers::SlotData<void()>(5, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'uploadCV'
        QtMocHelpers::SlotData<void()>(6, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'refreshDocumentStatus'
...
void ProfileWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->handleSaveChanges(); break;
        case 2: _t->handleOnboarding(); break;
        case 3: _t->uploadTranscript(); break;
        case 4: _t->uploadCV(); break;
        case 5: _t->refreshDocumentStatus(); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (ProfileWidget::*)()>(_a, &ProfileWidget::profileUpdated, 0))
            return;
    }
}
...
// SIGNAL 0
void ProfileWidget::profileUpdated()
{
